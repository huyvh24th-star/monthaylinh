...
namespace Web.Areas.Admin.Models
{
    ...
    {
        public int Id { get; set; }
        public string? Username { get; set; }       // tên tài khoản nếu đã login
        ...
        /// <summary>Tên hiển thị (ưu tiên account, sau đó guest name).</summary>
        public string DisplayName => Username ?? GuestName ?? "Khách vãng lai";
    }
    ...
    public class DashboardViewModel
    {
        ...
        public int UnrepliedFeedbacks { get; set; }
